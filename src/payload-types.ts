...
export interface FeatureBlock {
  features?:
    | {
        icon: 'shield' | 'lightning' | 'globe' | 'cog' | 'chart' | 'users' | 'lock' | 'rocket' | 'heart' | 'star';
        title: string;
        description: string;
        id?: string | null;
      }[]
...
export interface ProductCategoriesBlock {
  ...
  subtitle?: string | null;
  /**
   * Select categories to feature on the homepage
   */
  categories?: (string | ProductCategory)[] | null;
...
export interface Contact {
  ...
  /**
   * Internal notes for team members (not visible to contact)
   */
  notes?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface Header {
  id: string;
  /**
   * Upload a custom logo for the header. If not provided, the default logo will be used.
   */
  logo?: (string | null) | Media;
  /**
   * Site name to display alongside or instead of the logo.
   */
  ...
  navItems?:
    ...
    | null;
  /**
   * Show shopping cart icon in the header
   */
...
export interface Footer {
  id: string;
  /**
   * Upload a custom logo for the footer. If not provided, the default logo will be used.
   */
  logo?: (string | null) | Media;
  /**
   * Site name to display alongside or instead of the logo.
  ...
  siteName?: string | null;
  /**
   * Show site name in the footer
   */
  showSiteName?: boolean | null;
  /**
   * Brief description or tagline for your site
   */
  description?: string | null;
  navItems?:
    | {
  ...
  socialLinks?:
    | {
        platform?: ('facebook' | 'twitter' | 'instagram' | 'linkedin' | 'youtube' | 'github') | null;
        url: string;
        id?: string | null;
      }[]
    | null;
  /**
   * Show theme selector (light/dark mode toggle)
   */
  showThemeSelector?: boolean | null;
  /**
   * Custom copyright text. If not provided, will use default format.
   */
